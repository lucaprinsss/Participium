...
describe('MunicipalityUserController E2E Tests', () => {
    ...
    describe('POST /api/municipality/users - Create Municipality User', () => {
        ...
        it('should create municipality user successfully when authenticated as Admin', async () => {
            ...
            expect(response.body).toHaveProperty('role', 'Municipal Public Relations Officer');
            expect(response.body).not.toHaveProperty('password');
            expect(response.body).not.toHaveProperty('passwordHash');
            // Verify user was created in database
            const userExists = await userRepository_1.userRepository.existsUserByUsername(validMunicipalityUserData.username);
    ...
    describe('GET /api/municipality/users/:id - Get Municipality User By ID', () => {
        ...
        it('should return municipality user by ID when authenticated as Admin', async () => {
            ...
            expect(response.body).toHaveProperty('role', 'Infrastructure Manager');
            expect(response.body).not.toHaveProperty('password');
            expect(response.body).not.toHaveProperty('passwordHash');
        });
        it('should return 401 when not authenticated', async () => {
    ...
    describe('PUT /api/municipality/users/:id - Update Municipality User', () => {
        ...
        it('should update municipality user successfully when authenticated as Admin', async () => {
            ...
            const updateData = {
                ...
                role: 'Public Green Spaces Manager',
            };
            // Act
            const response = await (0, supertest_1.default)(app_1.default)
            ...
            expect(response.body).toHaveProperty('role', 'Public Green Spaces Manager');
    ...
    describe('DELETE /api/municipality/users/:id - Delete Municipality User', () => {
        ...
        it('should delete municipality user successfully when authenticated as Admin', async () => {
            ...
            const userExists = await userRepository_1.userRepository.existsUserByUsername('deletetest');
    ...
    describe('PUT /api/municipality/users/:id/role - Assign Role', () => {
        ...
        it('should return 400 for invalid user ID', async () => {
            ...
            const response = await (0, supertest_1.default)(app_1.default)
                ...
                .set('Cookie', adminCookies)
                .send({ role: 'Infrastructure Manager' })
                .expect('Content-Type', /json/)
                .expect(400);
            // Assert
            expect(response.body).toHaveProperty('message');
    ...
    describe('GET /api/roles - Get All Roles', () => {
        ...
        it('should return all municipality roles when authenticated as admin', async () => {
            ...
            expect(response.body).toContain('Municipal Administrator');
            expect(response.body).toContain('Technical Office Staff Member');
            expect(response.body).toContain('Urban Planning Manager');
            expect(response.body).toContain('Private Building Manager');
            expect(response.body).toContain('Infrastructure Manager');
            expect(response.body).toContain('Maintenance Staff Member');
            expect(response.body).toContain('Public Green Spaces Manager');
