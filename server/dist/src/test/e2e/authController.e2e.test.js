...
describe('AuthController E2E Tests', () => {
    ...
    describe('POST /api/sessions - Login with Dynamically Created User', () => {
        ...
        beforeEach(async () => {
            ...
            await userRepository_1.userRepository.createUserWithPassword({
    ...
    describe('Complete Authentication Flow', () => {
        it('should complete full login → get user → logout flow', async () => {
            ...
            const getCurrentResponse = await (0, supertest_1.default)(app_1.default)
                .get('/api/sessions/current')
                .set('Cookie', cookies)
                .expect(200);
        ...
        it('should handle multiple login sessions for same user', async () => {
            ...
            const session1 = await (0, supertest_1.default)(app_1.default)
                .post('/api/sessions')
                .send({
                username: 'testcitizen',
                password: 'TestPass123!',
                ...
                .expect(200);
            const session2 = await (0, supertest_1.default)(app_1.default)
                .post('/api/sessions')
                .send({
                username: 'testcitizen',
                password: 'TestPass123!',
