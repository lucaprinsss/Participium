...
describe('AuthService Integration Tests', () => {
    let mockUserEntity;
    let expectedDtoResponse;
    beforeEach(() => {
        const creationDate = new Date('2023-01-01T12:00:00Z');
        mockUserEntity = (0, mockEntities_1.createMockMunicipalityUser)('Administrator', 'Administration', {
            id: 123,
            username: 'testuser',
            firstName: 'Mario',
            lastName: 'Rossi',
    ...
    it('should correctly map a full user entity to a public UserResponse DTO', () => {
        // Arrange
        const expressUser = mockUserEntity;
        // Act
        const result = authService_1.authService.createUserResponse(expressUser);
        // Assert
    ...
    it('should map a different role (e.g., Citizen) correctly', () => {
        // Arrange
        mockUserEntity = (0, mockEntities_1.createMockCitizen)({
            id: 123,
            username: 'testuser',
            firstName: 'Mario',
            lastName: 'Rossi',
