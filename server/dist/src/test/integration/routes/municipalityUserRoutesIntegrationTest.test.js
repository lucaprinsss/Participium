...
const mockCreateUser = municipalityUserController_1.default.createMunicipalityUser;
const mockGetAllUsers = municipalityUserController_1.default.getAllMunicipalityUsers;
const mockGetUserById = municipalityUserController_1.default.getMunicipalityUserById;
const mockUpdateUser = municipalityUserController_1.default.updateMunicipalityUser;
const mockDeleteUser = municipalityUserController_1.default.deleteMunicipalityUser;
const mockAssignRole = municipalityUserController_1.default.assignRole;
...
describe('Municipality User Routes Integration Tests', () => {
    ...
    describe('GET /api/municipality/users', () => {
        it('should return 401 if user is not authenticated', async () => {
            const res = await (0, supertest_1.default)(app).get('/api/municipality/users');
            expect(res.status).toBe(401);
    ...
    describe('GET /api/municipality/users/:id', () => {
        it('should return 401 if user is not authenticated', async () => {
            const res = await (0, supertest_1.default)(app).get('/api/municipality/users/1');
            expect(res.status).toBe(401);
    ...
    describe('DELETE /api/municipality/users/:id', () => {
        it('should return 401 if user is not authenticated', async () => {
            const res = await (0, supertest_1.default)(app).delete('/api/municipality/users/1');
            expect(res.status).toBe(401);
